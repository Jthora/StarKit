...
open class CoreAstrology {
    ...
    public enum AspectRelationType:Double, CaseIterable {
    ...
    public enum AspectBody: Int, CaseIterable {
        case sun
        case moon
        case mercury
        case venus
        ...
        public var hasGravity:Bool {
            switch self {
                case .moon, .sun, .mercury, .venus, .mars, .jupiter, .saturn, .uranus, .neptune, .pluto: return true
            default: return false
            }
        }
        
        public static var bodiesWithGravity:[AspectBody] = [.moon,
                                                     .sun,
                                                     .mercury,
                                                     .venus,
                                                     .mars,
        ...
        public func normalVector(date:Date) -> Vector3 {
        ...
        public func gravimetricTensor(date:Date) -> GravimetricTensor {
            guard let magnitude = gravimetricForceOnEarth(date: date) else { return .empty }
            let vectorNormal = normalVector(date: date)
